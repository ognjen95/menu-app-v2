        ...
        <div className="flex flex-col min-h-screen bg-secondary">
            ...
            <div className="w-full py-20 lg:py-32 xl:py-40">
                <div className="text-center py-6 md:py-10 lg:py-12 ">
                    <h1 className="font-bold text-xl md:text-3xl lg:text-4xl ">{t('title')}</h1>
                    <h1 className="pt-4 text-muted-foreground text-sm md:text-md lg:text-lg">{t('description')}</h1>
                </div>
