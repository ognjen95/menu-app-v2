              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                  {website.social_links.facebook && (
                    <a href={website.social_links.facebook} target="_blank" rel="noopener noreferrer">
                      <Facebook size={24} color={theme.foreground} />
                    </a>
                  )}
                  {website.social_links.instagram && (
                    <a href={website.social_links.instagram} target="_blank" rel="noopener noreferrer">
                      <Instagram size={24} color={theme.foreground} />
                    </a>
                  )}
                  {website.social_links.twitter && (
                    <a href={website.social_links.twitter} target="_blank" rel="noopener noreferrer">
                      <Twitter size={24} color={theme.foreground} />
                    </a>
                  )}
                </div>
              </div>
...
function BlockRenderer({ block, theme, menuItems }: { 
  ...
  switch (block.type) {
    ...
    case 'testimonials':
      const testimonials = (content.testimonials as { name: string; text: string; rating?: number }[]) || []
      return (
        <section style={{ ...sectionStyle, backgroundColor: theme.secondary, maxWidth: '100%' }}>
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <h2 style={{ fontFamily: theme.fontHeading, fontSize: '2rem', marginBottom: '2rem', textAlign: 'center' }}>
            ...
            <div style={{ 
              ...
              {testimonials.map((t, idx) => (
                <div key={idx} style={{ 
                  ...
                  <p style={{ fontStyle: 'italic', marginBottom: '1rem' }}>&ldquo;{t.text}&rdquo;</p>
