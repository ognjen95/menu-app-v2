...
const page = () => {
  return (
    <div id='klopay-privacy-policy'>
      <h1>Privacy Policy</h1>
      <p>Updated at 2026-03-24</p>
      <p>Klopay (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
      ...
      <p>
        ...
        application,
        Klopay. By accessing or using our Service, you signify that you have read, understood, and agree to
      ...
      <ul>
        ...
        <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to
          Klopay, that is responsible for your information under this Privacy Policy.
        </li>
        <li>Country: where
          Klopay or the owners/founders of
          Klopay are based, in this case is Spain
        </li>
        <li>Customer: refers to the company, organization or person that signs up to use the
          Klopay Service to manage the relationships with your consumers or service users.
        </li>
        <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to
          visit
          Klopay and use the services.
        </li>
        ...
        <li>Personnel: refers to those individuals who are employed by
          Klopay or are under contract to perform a service on behalf of one of the parties.
        </li>
        ...
        <li>Service: refers to the service provided by
          Klopay as described in the relative terms (if available) and on this platform.
        </li>
        ...
        <li>Website:
          Klopay's site, which can be accessed via this URL: https://www.klopay.app/
        </li>
        <li>You: a person or entity that is registered with
          Klopay to use the Services.
        </li>
      </ul>
      <h1>What Information Do We Collect?</h1>
      <p>We collect information from you when you visit our website, register on our site, place an order, subscribe to our
      ...
      <h1>When does Klopay use end user information from third parties?</h1>
      <p>Klopay will collect End User Data necessary to provide the Klopay services to our customers.</p>
      ...
      <h1>When does Klopay use customer information from third parties?</h1>
      <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a Klopay customer, we receive information from a third party that provides automated fraud detection services to Klopay. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
      ...
      <p>Klopay will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
      ...
      <p>The rights you have to request updates or corrections to the information Klopay collects depend on your relationship with Klopay. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
      ...
      <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of Klopay or any of its Corporate Affiliates (as defined herein), or that portion of Klopay or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
      <h1>Affiliates</h1>
      <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "
        ...
        common control with Klopay, whether by ownership or otherwise. Any information relating to you
      ...
      <h1>Governing Law</h1>
      <p>This Privacy Policy is governed by the laws of Spain without regard to its conflict of laws provision.
      ...
      <p>The laws of Spain, excluding its conflicts of law rules, shall govern this Agreement and your use of
        the website. Your use of the website may also be subject to other local, state, national, or international
        laws.</p>
      <p>By using
        Klopay or contacting us directly, you signify your acceptance of this Privacy Policy. If you do
      ...
      <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated
        or controlled by
        Klopay. We are not responsible for the content, accuracy or opinions expressed in such websites,
      ...
      <h1>Cookies</h1>
      <p>Klopay uses "Cookies" to identify the areas of our website that you have visited. A Cookie is
      ...
      <p>You acknowledge and agree that
        Klopay shall not be responsible for any Third-Party Services, including their accuracy,
        completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof.
        Klopay does not assume and shall not have any liability or responsibility to you or any other
